...
export default function DemoPage() {
  return <div className="page-shell demo-page">
    <div className="page-heading"><div><div className="eyebrow">Five-minute live demo</div><h1>Follow the fact.</h1></div><p>Case <strong>cx-1</strong> is the finalized Crux evidence flow: baseline uncertainty, a committed source, independent verification, closure, and withdrawal.</p></div>
    ...
    <ol className="demo-steps">
      <li><span>01</span><div><h2>Start unresolved</h2><p>Wallet A funded cx-1. The baseline fact established the chain ID but not the RPC, so consensus kept the case insufficient.</p><a href={tx("0xecfe5c8607598584ae46cb6b436a9466b303c0d3b12e403c22f9c7a135353ddd")} target="_blank" rel="noreferrer">Create transaction ↗</a></div></li>
    ...
    <div className="demo-footer"><Link className="primary-button acid" href="/cases/cx-1">Open cx-1 in Crux</Link><Link className="secondary-button" href="/protocol">Read the trust architecture</Link></div>
  </div>;
}
